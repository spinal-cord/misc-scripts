...
echo -n "SETUP: pkg_resources.get_distribution('xformers').version == " && python -c "import sys, pkg_resources; from pkg_resources import DistributionNotFound; exec(\"\"\"try:\n    print(pkg_resources.get_distribution('xformers').version)\nexcept DistributionNotFound:\n    try:\n        import xformers\n        print(xformers.__version__)\n    except Exception:\n        print('not found or no version info')\"\"\")"
echo -n "SETUP: version('sageattention') == " && python -c "import sys, importlib.metadata; from importlib.metadata import PackageNotFoundError; exec(\"\"\"try:\n    print(importlib.metadata.version('sageattention'))\nexcept PackageNotFoundError:\n    try:\n        import sageattention\n        print(sageattention.__version__)\n    except Exception:\n        print('not found or no version info')\"\"\")"
echo -n "SETUP: version('sageattn3') == " && python -c "import sys, importlib.metadata; from importlib.metadata import PackageNotFoundError; exec(\"\"\"try:\n    print(importlib.metadata.version('sageattn3'))\nexcept PackageNotFoundError:\n    try:\n        import sageattn3\n        print(sageattn3.__version__)\n    except Exception:\n        print('not found or no version info')\"\"\")"
